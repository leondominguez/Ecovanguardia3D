...
export function SharkModel(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF('/models-3d/fish/atlantic_explorer_submarineglb.glb');
...
useGLTF.preload('/models-3d/fish/atlantic_explorer_submarineglb.glb')
