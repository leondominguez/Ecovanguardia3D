...
const DeepOcean = forwardRef(
  (
    ...
    const group = useRef();
    const { nodes, materials, animations } = useGLTF("/models-3d/lobbyModels/DeepOcean.glb");
...
useGLTF.preload('/models-3d/lobbyModels/DeepOcean.glb');